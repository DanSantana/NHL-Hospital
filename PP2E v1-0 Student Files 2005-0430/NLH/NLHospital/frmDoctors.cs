...
namespace NLHospital
{
    ...
    public class frmDoctors : NLHBase
    {
        ...
        public frmDoctors( frmMenu MYMENU)
        {
            //
        ...
        private void LoadSpecialtyData()
        {
            ...
            SqlConnection con = new SqlConnection(Settings.Default.StringConnection);
            con.Open();

            SqlCommand comand = new SqlCommand("select * from Speciality", con);
            comand.CommandType = CommandType.Text;

            SqlDataAdapter cAdapt = new SqlDataAdapter(comand);

            cAdapt.Fill(speciality);

            foreach (DataRow line in speciality.Rows)
            {
                cboSpecialty.Items.Add(line[0].ToString());
            }
            con.Close();
        }
        ...
        private void btnFind_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                cboSpecialty.SelectedItem = o_Find.Tables["Doctors"].Rows[0]["Specialty"].ToString();
            ...
            {
                MessageBox.Show(sMsg, "Find Record", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void btnUpdate_Click(object sender, System.EventArgs e)
        {
            ...
            try
            {
                ...
                //sMsg += docID + " Successfully updated";
            }
            catch
            {
                sMsg = "Error saving data." + "\n\n" + e.ToString();
            ...
            {
                MessageBox.Show(sMsg, "Update Record", MessageBoxButtons.OK,MessageBoxIcon.Exclamation);
                dgDoctors.Update();
            }
        }
